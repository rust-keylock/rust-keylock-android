...
CC="${ANDROID_TOOLCHAIN_DIR}/bin/arm-linux-androideabi-gcc" OPENSSL_DIR=${OPENSSL_BUILD_DIR} OPENSSL_LIB_DIR=${OPENSSL_BUILD_DIR}/lib OPENSSL_INCLUDE_DIR=${OPENSSL_BUILD_DIR}/include OPENSSL_STATIC=true J4RS_SKIP_SETTING_ENV=true $CARGO_HOME/bin/cargo build --target=arm-linux-androideabi --release
